...
public class TennisController implements IController {
	...
	String recap, last, previous, next;
...
//		}
	...
	public void processPost(IWebExchange webExchange, TemplateEngine templateEngine, HttpServletResponse resp)
		...
		servep1 = Boolean.parseBoolean(request.getParameterValue("p1Serv"));
		servep2 = Boolean.parseBoolean(request.getParameterValue("p2Serv"));
		if(tennis.server == 1) {
			servep1 = true;
			servep2 = false;
		}
